...
<html>
    ...
    <div class="flex flex-col items-center justify-center space-y-6">
      ...
      <h1 class="text-3xl font-semibold text-gray-900 flex items-center"><?= $phone ?> <a id="copy" href="#" onclick="copyToClipboard('<?= $phone ?>');return false;" class="text-gray-500 text-xl"><i class="fa-solid fa-copy"></i></a></h1>
      <!-- Skambinimo mygtukas -->
      <button
